...
static const MAP_HEX_ADJACENT_HEX_COORDINATES = [[+0, +2],
                                                 [+2, +2],
                                                 [+2, +0],
                                                 [+0, -2],
                                                 [-2, -2],
...
static const MAP_HEX_ADJACENT_NODE_COORDINATES = [[+0, +1],
                                                  [+1, +2],
                                                  [+2, +1],
                                                  [+1, +0],
                                                  [+0, -1],
...
static const MAP_HEX_ADJACENT_EDGE_COORDINATES = [[+0, +1],
                                                  [+1, +1],
                                                  [+1, +0],
                                                  [+0, -1],
                                                  [-1, -1],
